...
coreService.factory('ptBasicService', function () {
    var url = {
...
coreService.factory('ptGlobalDataService', function () {
    var globalData = {
        'tempData': '',
        'idx': '',
        'service': '',
...
coreService.factory('ptGlobalMethodService', function ($window, $timeout) {
    return {
...
coreService.factory('ptForwardService', function ($window, ptBasicService) {
    return {
        ...
        'setRedirect': function (url, params) {
            ...
            paramText = paramText + 'pageSize=' + ptBasicService.pageSize;
            redirect.url = url;
            if (params === '') {
                redirect.params = '';
            } else {
 ...
 * */
coreService.factory('ptValidateService', function () {
    return {
